...
@:pythonImport("bpy_extras.view3d_utils") extern class Module {
	/**
		...
		@param pyrv3d 3D region data, typically bpy.context.space_data.region_3d. — bpy.types.RegionView3D
	...
	**/
	static function pyregion_2d_to_vector_3d(region:Dynamic, pyrv3d:Dynamic, coord:Dynamic):mathutils.vector.Vector;
	/**
		...
		@returns mathutils.Vector
	**/
	static function pyregion_2d_to_origin_3d(region:Dynamic, pyrv3d:Dynamic, coord:Dynamic, clamp:Float):mathutils.vector.Vector;
	/**
		...
		@returns mathutils.Vector
	**/
	static function pyregion_2d_to_location_3d(region:Dynamic, pyrv3d:Dynamic, coord:Dynamic, depth_location:Dynamic):mathutils.vector.Vector;
	/**
		Return the region relative 2d location of a 3d position.
		@param region region of the 3D viewport, typically bpy.context.region. — bpy.types.Region
		@param pyrv3d 3D region data, typically bpy.context.space_data.region_3d. — bpy.types.RegionView3D
		@param coord 3d worldspace location. — 3d vector
		@param pyDefault Return this value if coord
		                                        is behind the origin of a perspective view. — 
		
		@returns mathutils.Vector or default argument.
	**/
	static function pylocation_3d_to_region_2d(region:Dynamic, pyrv3d:Dynamic, coord:Dynamic, pyDefault:Dynamic):mathutils.vector.Vector;
}