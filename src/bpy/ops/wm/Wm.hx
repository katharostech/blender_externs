...
@:enum abstract Enum1(String) from String to String {
	...
	var DRAW_SWAP : String = "DRAW_SWAP";
	var DRAW_WIN : String = "DRAW_WIN";
	var DRAW_WIN_SWAP : String = "DRAW_WIN_SWAP";
	var ANIM_STEP : String = "ANIM_STEP";
	var ANIM_PLAY : String = "ANIM_PLAY";
