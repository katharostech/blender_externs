package bpy.types.maintainvolumeconstraint;
@:enum abstract Enum1(String) from String to String {
	var SAMEVOL_X : String = "SAMEVOL_X";
	var SAMEVOL_Y : String = "SAMEVOL_Y";
	var SAMEVOL_Z : String = "SAMEVOL_Z";
}/**
	Maintain a constant volume along a single scaling axis
**/
@:pythonImport("bpy.types.MaintainVolumeConstraint") extern class MaintainVolumeConstraint {
	/**
		The free scaling axis of the object
		
		Type: enum in [‘SAMEVOL_X’, ‘SAMEVOL_Y’, ‘SAMEVOL_Z’], default ‘SAMEVOL_X’
	**/
	var free_axis : bpy.types.maintainvolumeconstraint.MaintainVolumeConstraint.Enum1;
	/**
