package bpy.types.shadernodemixrgb;
@:enum abstract Enum1(String) from String to String {
...
}@:pythonImport("bpy.types.ShaderNodeMixRGB") extern class ShaderNodeMixRGB {
	/**
	...
	**/
	var blend_type : bpy.types.shadernodemixrgb.ShaderNodeMixRGB.Enum1;
	/**
