package bpy.types.clamptoconstraint;
@:enum abstract Enum1(String) from String to String {
	var CLAMPTO_AUTO : String = "CLAMPTO_AUTO";
	var CLAMPTO_X : String = "CLAMPTO_X";
	var CLAMPTO_Y : String = "CLAMPTO_Y";
	var CLAMPTO_Z : String = "CLAMPTO_Z";
}/**
...
@:native("bpy.types.ClampToConstraint") extern class ClampToConstraint {
	...
	**/
	var main_axis : bpy.types.clamptoconstraint.ClampToConstraint.Enum1;
	/**
