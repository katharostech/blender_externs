package bpy.types.shadernodetree;
@:enum abstract Enum1(String) from String to String {
	var ALL : String = "ALL";
	var EEVEE : String = "EEVEE";
	var CYCLES : String = "CYCLES";
}/**
	Node tree consisting of linked nodes used for materials (and other shading data-blocks)
**/
@:pythonImport("bpy.types.ShaderNodeTree") extern class ShaderNodeTree {
	/**
		Return active shader output node for the specified target
		@param target TargetALL All, Use shaders for all renderers and viewports, unless there exists a more specific output.EEVEE Eevee, Use shaders for Eevee renderer.CYCLES Cycles, Use shaders for Cycles renderer. — enum in ['ALL', 'EEVEE', 'CYCLES']
		
		@returns ShaderNode
	**/
	function get_output_node(target:bpy.types.shadernodetree.ShaderNodeTree.Enum1):bpy.types.shadernode.ShaderNode;
	/**
