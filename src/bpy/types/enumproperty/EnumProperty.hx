package bpy.types.enumproperty;
...
@:pythonImport("bpy.types.EnumProperty") extern class EnumProperty {
	...
	**/
	var default_flag(default, never) : Dynamic;
	/**
		Possible values for the property
		
		Type: bpy_prop_collection of EnumPropertyItem, (readonly)
	**/
	var enum_items(default, never) : bpy.types.bpy_prop_collection.Bpy_prop_collection;
	/**
		Possible values for the property (never calls optional dynamic generation of those)
		
		Type: bpy_prop_collection of EnumPropertyItem, (readonly)
	**/
	var enum_items_static(default, never) : bpy.types.bpy_prop_collection.Bpy_prop_collection;
	/**
