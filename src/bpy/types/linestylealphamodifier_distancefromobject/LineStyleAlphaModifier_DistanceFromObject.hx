package bpy.types.linestylealphamodifier_distancefromobject;
...
**/
@:pythonImport("bpy.types.LineStyleAlphaModifier_DistanceFromObject") extern class LineStyleAlphaModifier_DistanceFromObject {
	/**
		Specify how the modifier value is blended into the base value
		
		Type: enum in [‘MIX’, ‘ADD’, ‘SUBTRACT’, ‘MULTIPLY’, ‘DIVIDE’, ‘DIFFERENCE’, ‘MINIMUM’, ‘MAXIMUM’], default ‘MIX’
	**/
	var blend : bpy.types.linestylealphamodifier_distancefromobject.LineStyleAlphaModifier_DistanceFromObject.Enum1;
	/**
	...
	**/
	var mapping : bpy.types.linestylealphamodifier_distancefromobject.LineStyleAlphaModifier_DistanceFromObject.Enum2;
	/**
	...
	**/
	var type(default, never) : bpy.types.linestylealphamodifier_distancefromobject.LineStyleAlphaModifier_DistanceFromObject.Enum3;
	/**
