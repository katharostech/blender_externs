package bpy.types.nodesocketinterfaceintpercentage;
/**
	Integer number socket of a node
**/
@:pythonImport("bpy.types.NodeSocketInterfaceIntPercentage") extern class NodeSocketInterfaceIntPercentage {
	/**
