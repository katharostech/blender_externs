package bpy.types.nodegroupoutput;
@:pythonImport("bpy.types.NodeGroupOutput") extern class NodeGroupOutput {
	/**
		Interface socket data
		
		Type: PropertyGroup, (readonly)
	**/
	var interface(default, never) : bpy.types.propertygroup.PropertyGroup;
	/**
