package bpy.types.noisegpencilmodifier;
/**
	Noise effect modifier
**/
@:pythonImport("bpy.types.NoiseGpencilModifier") extern class NoiseGpencilModifier {
	/**
