package bpy.types.compositornodecolorbalance;
@:enum abstract Enum1(String) from String to String {
	var LIFT_GAMMA_GAIN : String = "LIFT_GAMMA_GAIN";
	var OFFSET_POWER_SLOPE : String = "OFFSET_POWER_SLOPE";
}@:pythonImport("bpy.types.CompositorNodeColorBalance") extern class CompositorNodeColorBalance {
	/**
		
		
		Type: enum in [‘LIFT_GAMMA_GAIN’, ‘OFFSET_POWER_SLOPE’], default ‘LIFT_GAMMA_GAIN’
	**/
	var correction_method : bpy.types.compositornodecolorbalance.CompositorNodeColorBalance.Enum1;
	/**
