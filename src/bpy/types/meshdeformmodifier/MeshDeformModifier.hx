package bpy.types.meshdeformmodifier;
/**
	Mesh deformation modifier to deform with other meshes
**/
@:pythonImport("bpy.types.MeshDeformModifier") extern class MeshDeformModifier {
	/**
	...
	**/
	var is_bound(default, never) : Bool;
	/**
