package bpy.types.shadernodetexies;
@:enum abstract Enum1(String) from String to String {
	var INTERNAL : String = "INTERNAL";
	var EXTERNAL : String = "EXTERNAL";
}@:pythonImport("bpy.types.ShaderNodeTexIES") extern class ShaderNodeTexIES {
	/**
		IES light path
