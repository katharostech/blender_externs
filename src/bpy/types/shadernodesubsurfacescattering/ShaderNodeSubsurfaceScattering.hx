package bpy.types.shadernodesubsurfacescattering;
@:enum abstract Enum1(String) from String to String {
	var CUBIC : String = "CUBIC";
	var GAUSSIAN : String = "GAUSSIAN";
	var BURLEY : String = "BURLEY";
	var RANDOM_WALK : String = "RANDOM_WALK";
}@:pythonImport("bpy.types.ShaderNodeSubsurfaceScattering") extern class ShaderNodeSubsurfaceScattering {
	/**
	...
	**/
	var falloff : bpy.types.shadernodesubsurfacescattering.ShaderNodeSubsurfaceScattering.Enum1;
	/**
