package bpy.types.compositornodeglare;
@:enum abstract Enum1(String) from String to String {
	var GHOSTS : String = "GHOSTS";
	var STREAKS : String = "STREAKS";
	var FOG_GLOW : String = "FOG_GLOW";
	var SIMPLE_STAR : String = "SIMPLE_STAR";
}@:enum abstract Enum2(String) from String to String {
	var HIGH : String = "HIGH";
	var MEDIUM : String = "MEDIUM";
	var LOW : String = "LOW";
}@:pythonImport("bpy.types.CompositorNodeGlare") extern class CompositorNodeGlare {
	/**
		Streak angle offset
	...
	**/
	var glare_type : bpy.types.compositornodeglare.CompositorNodeGlare.Enum1;
	/**
	...
	**/
	var quality : bpy.types.compositornodeglare.CompositorNodeGlare.Enum2;
	/**
