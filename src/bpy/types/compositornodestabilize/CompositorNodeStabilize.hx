package bpy.types.compositornodestabilize;
@:enum abstract Enum1(String) from String to String {
	var NEAREST : String = "NEAREST";
	var BILINEAR : String = "BILINEAR";
	var BICUBIC : String = "BICUBIC";
}@:pythonImport("bpy.types.CompositorNodeStabilize") extern class CompositorNodeStabilize {
	/**
	...
	**/
	var filter_type : bpy.types.compositornodestabilize.CompositorNodeStabilize.Enum1;
	/**
