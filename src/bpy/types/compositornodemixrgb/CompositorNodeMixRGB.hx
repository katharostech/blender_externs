package bpy.types.compositornodemixrgb;
@:enum abstract Enum1(String) from String to String {
...
}@:pythonImport("bpy.types.CompositorNodeMixRGB") extern class CompositorNodeMixRGB {
	/**
	...
	**/
	var blend_type : bpy.types.compositornodemixrgb.CompositorNodeMixRGB.Enum1;
	/**
