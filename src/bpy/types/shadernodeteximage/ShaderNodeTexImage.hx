package bpy.types.shadernodeteximage;
@:enum abstract Enum1(String) from String to String {
...
}@:pythonImport("bpy.types.ShaderNodeTexImage") extern class ShaderNodeTexImage {
	/**
		Color mapping settings
		
		Type: ColorMapping, (readonly, never None)
	**/
	var color_mapping(default, never) : bpy.types.colormapping.ColorMapping;
	/**
		Image file color space
		
		Type: enum in [‘COLOR’, ‘NONE’], default ‘COLOR’
	**/
	var color_space : bpy.types.shadernodeteximage.ShaderNodeTexImage.Enum1;
	/**
		How the image is extrapolated past its original bounds
		
		Type: enum in [‘REPEAT’, ‘EXTEND’, ‘CLIP’], default ‘REPEAT’
	**/
	var extension : bpy.types.shadernodeteximage.ShaderNodeTexImage.Enum2;
	/**
	...
	**/
	var interpolation : bpy.types.shadernodeteximage.ShaderNodeTexImage.Enum3;
	/**
		Method to project 2D image on object with a 3D texture vector
		
		Type: enum in [‘FLAT’, ‘BOX’, ‘SPHERE’, ‘TUBE’], default ‘FLAT’
	**/
	var projection : bpy.types.shadernodeteximage.ShaderNodeTexImage.Enum4;
	/**
		For box projection, amount of blend to use between sides
		
		Type: float in [0, 1], default 0.0
	**/
	var projection_blend : Float;
	/**
		Texture coordinate mapping settings
		
		Type: TexMapping, (readonly, never None)
	**/
	var texture_mapping(default, never) : bpy.types.texmapping.TexMapping;
	/**
