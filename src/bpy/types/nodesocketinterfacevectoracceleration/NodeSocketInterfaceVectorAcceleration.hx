package bpy.types.nodesocketinterfacevectoracceleration;
/**
	3D vector socket of a node
**/
@:pythonImport("bpy.types.NodeSocketInterfaceVectorAcceleration") extern class NodeSocketInterfaceVectorAcceleration {
	/**
