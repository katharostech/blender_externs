...
**/
@:native("bpy.types.Sound") extern class Sound {
	/**
	...
	**/
	...
	/**
		...
		(readonly)
	**/
	var factory(default, never) : Dynamic;
	/**
	...
	**/
	function unpack(method:bpy.types.sound.Sound.Enum1):Void;
	/**
