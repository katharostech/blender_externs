package bpy.types.compositornodecombycca;
@:enum abstract Enum1(String) from String to String {
	var ITUBT601 : String = "ITUBT601";
	var ITUBT709 : String = "ITUBT709";
	var JFIF : String = "JFIF";
}@:pythonImport("bpy.types.CompositorNodeCombYCCA") extern class CompositorNodeCombYCCA {
	/**
		
		
		Type: enum in [‘ITUBT601’, ‘ITUBT709’, ‘JFIF’], default ‘ITUBT601’
	**/
	var mode : bpy.types.compositornodecombycca.CompositorNodeCombYCCA.Enum1;
	/**
