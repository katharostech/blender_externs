package bpy.types.compositornodeimage;
@:enum abstract Enum1(String) from String to String {
	var PLACEHOLDER : String = "PLACEHOLDER";
}@:enum abstract Enum2(String) from String to String {
	var ALL : String = "ALL";
}@:pythonImport("bpy.types.CompositorNodeImage") extern class CompositorNodeImage {
	/**
	...
	**/
	var has_layers(default, never) : Bool;
	/**
		True if this image has multiple views
		
		Type: boolean, default False, (readonly)
	**/
	var has_views(default, never) : Bool;
	/**
	...
	**/
	var layer : bpy.types.compositornodeimage.CompositorNodeImage.Enum1;
	/**
	...
	**/
	...
	/**
		...
		Type: boolean, default False
	**/
	var use_straight_alpha_output : Bool;
	/**
		
		
		Type: enum in [‘ALL’], default ‘ALL’
	**/
	var view : bpy.types.compositornodeimage.CompositorNodeImage.Enum2;
	/**
