package bpy.types.tintgpencilmodifier;
...
**/
@:pythonImport("bpy.types.TintGpencilModifier") extern class TintGpencilModifier {
	/**
	...
	**/
	var modify_color : bpy.types.tintgpencilmodifier.TintGpencilModifier.Enum1;
	/**
		Pass index
