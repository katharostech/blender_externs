package bpy.types.linestylecolormodifier_material;
...
**/
@:pythonImport("bpy.types.LineStyleColorModifier_Material") extern class LineStyleColorModifier_Material {
	/**
	...
	**/
	var blend : bpy.types.linestylecolormodifier_material.LineStyleColorModifier_Material.Enum1;
	/**
	...
	**/
	var material_attribute : bpy.types.linestylecolormodifier_material.LineStyleColorModifier_Material.Enum2;
	/**
	...
	**/
	var type(default, never) : bpy.types.linestylecolormodifier_material.LineStyleColorModifier_Material.Enum3;
	/**
