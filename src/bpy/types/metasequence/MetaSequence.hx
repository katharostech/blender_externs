package bpy.types.metasequence;
...
@:pythonImport("bpy.types.MetaSequence") extern class MetaSequence {
	...
	**/
	var alpha_mode : bpy.types.metasequence.MetaSequence.Enum1;
	/**
	...
	**/
	var sequences(default, never) : bpy.types.bpy_prop_collection.Bpy_prop_collection;
	/**
