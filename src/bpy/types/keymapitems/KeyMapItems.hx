...
**/
@:native("bpy.types.KeyMapItems") extern class KeyMapItems {
	/**
		new
		...
		@returns KeyMapItem
	**/
	function pyNew(idname:String, type:bpy.types.keymapitems.KeyMapItems.Enum1, value:bpy.types.keymapitems.KeyMapItems.Enum2, any:Bool, shift:Bool, ctrl:Bool, alt:Bool, oskey:Bool, key_modifier:bpy.types.keymapitems.KeyMapItems.Enum3, head:Bool):bpy.types.keymapitem.KeyMapItem;
	/**
		new_modal
