package bpy.types.compositornodechromamatte;
@:pythonImport("bpy.types.CompositorNodeChromaMatte") extern class CompositorNodeChromaMatte {
	/**
		Alpha falloff
