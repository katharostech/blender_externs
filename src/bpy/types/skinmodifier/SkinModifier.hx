package bpy.types.skinmodifier;
/**
	Generate Skin
**/
@:pythonImport("bpy.types.SkinModifier") extern class SkinModifier {
	/**
		Smooth complex geometry around branches
		
		Type: float in [0, 1], default 0.0
	**/
	var branch_smoothing : Float;
	/**
