package bpy.types.compositornodepremulkey;
@:enum abstract Enum1(String) from String to String {
	var STRAIGHT_TO_PREMUL : String = "STRAIGHT_TO_PREMUL";
	var PREMUL_TO_STRAIGHT : String = "PREMUL_TO_STRAIGHT";
}@:pythonImport("bpy.types.CompositorNodePremulKey") extern class CompositorNodePremulKey {
	/**
	...
	**/
	var mapping : bpy.types.compositornodepremulkey.CompositorNodePremulKey.Enum1;
	/**
