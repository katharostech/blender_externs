package bpy.types.shadernodetexsky;
@:enum abstract Enum1(String) from String to String {
	var PREETHAM : String = "PREETHAM";
	var HOSEK_WILKIE : String = "HOSEK_WILKIE";
}@:pythonImport("bpy.types.ShaderNodeTexSky") extern class ShaderNodeTexSky {
	/**
