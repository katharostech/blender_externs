package bpy.types.compositornodeboxmask;
@:enum abstract Enum1(String) from String to String {
	var ADD : String = "ADD";
	var SUBTRACT : String = "SUBTRACT";
	var MULTIPLY : String = "MULTIPLY";
	var NOT : String = "NOT";
}@:pythonImport("bpy.types.CompositorNodeBoxMask") extern class CompositorNodeBoxMask {
	/**
		Height of the box
	...
	**/
	var mask_type : bpy.types.compositornodeboxmask.CompositorNodeBoxMask.Enum1;
	/**
