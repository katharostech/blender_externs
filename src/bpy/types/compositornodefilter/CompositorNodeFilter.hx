package bpy.types.compositornodefilter;
@:enum abstract Enum1(String) from String to String {
	var SOFTEN : String = "SOFTEN";
	var SHARPEN : String = "SHARPEN";
	var LAPLACE : String = "LAPLACE";
	var SOBEL : String = "SOBEL";
	var PREWITT : String = "PREWITT";
	var KIRSCH : String = "KIRSCH";
	var SHADOW : String = "SHADOW";
}@:pythonImport("bpy.types.CompositorNodeFilter") extern class CompositorNodeFilter {
	/**
		
		
		Type: enum in [‘SOFTEN’, ‘SHARPEN’, ‘LAPLACE’, ‘SOBEL’, ‘PREWITT’, ‘KIRSCH’, ‘SHADOW’], default ‘SOFTEN’
	**/
	var filter_type : bpy.types.compositornodefilter.CompositorNodeFilter.Enum1;
	/**
