package bpy.types.nodesocketinterfacevectordirection;
/**
	3D vector socket of a node
**/
@:pythonImport("bpy.types.NodeSocketInterfaceVectorDirection") extern class NodeSocketInterfaceVectorDirection {
	/**
