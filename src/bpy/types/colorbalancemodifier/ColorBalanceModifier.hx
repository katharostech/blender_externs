package bpy.types.colorbalancemodifier;
/**
	Color balance modifier for sequence strip
**/
@:pythonImport("bpy.types.ColorBalanceModifier") extern class ColorBalanceModifier {
	/**
		
		
		Type: SequenceColorBalanceData, (readonly)
	**/
	var color_balance(default, never) : bpy.types.sequencecolorbalancedata.SequenceColorBalanceData;
	/**
