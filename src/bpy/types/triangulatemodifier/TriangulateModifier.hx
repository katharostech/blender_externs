package bpy.types.triangulatemodifier;
...
@:native("bpy.types.TriangulateModifier") extern class TriangulateModifier {
	...
	**/
	var ngon_method : bpy.types.triangulatemodifier.TriangulateModifier.Enum1;
	/**
		Method for splitting the quads into triangles
		
		Type: enum in [‘BEAUTY’, ‘FIXED’, ‘FIXED_ALTERNATE’, ‘SHORTEST_DIAGONAL’], default ‘BEAUTY’
	**/
	var quad_method : bpy.types.triangulatemodifier.TriangulateModifier.Enum2;
	/**
