package bpy.types.clothmodifier;
/**
	Cloth simulation modifier
**/
@:pythonImport("bpy.types.ClothModifier") extern class ClothModifier {
	/**
		
		
		Type: ClothCollisionSettings, (readonly, never None)
	**/
	var collision_settings(default, never) : bpy.types.clothcollisionsettings.ClothCollisionSettings;
	/**
		
		
		Type: float array of 3 items in [-inf, inf], default (0.0, 0.0, 0.0), (readonly)
	**/
	var hair_grid_max(default, never) : Array<Float>;
	/**
		
		
		Type: float array of 3 items in [-inf, inf], default (0.0, 0.0, 0.0), (readonly)
	**/
	var hair_grid_min(default, never) : Array<Float>;
	/**
		
		
		Type: int array of 3 items in [-inf, inf], default (0, 0, 0), (readonly)
	**/
	var hair_grid_resolution(default, never) : Array<Int>;
	/**
	...
	**/
	var settings(default, never) : bpy.types.clothsettings.ClothSettings;
	/**
		
		
		Type: ClothSolverResult, (readonly)
	**/
	var solver_result(default, never) : bpy.types.clothsolverresult.ClothSolverResult;
	/**
