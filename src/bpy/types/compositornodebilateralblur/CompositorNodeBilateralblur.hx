package bpy.types.compositornodebilateralblur;
@:pythonImport("bpy.types.CompositorNodeBilateralblur") extern class CompositorNodeBilateralblur {
	/**
	...
	**/
	var sigma_color : Float;
	/**
		
		
		Type: float in [0.01, 30], default 0.0
	**/
	var sigma_space : Float;
	/**
