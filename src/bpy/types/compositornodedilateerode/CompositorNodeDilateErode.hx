package bpy.types.compositornodedilateerode;
@:enum abstract Enum1(String) from String to String {
	...
	var FEATHER : String = "FEATHER";
}@:pythonImport("bpy.types.CompositorNodeDilateErode") extern class CompositorNodeDilateErode {
	/**
	...
	**/
	var falloff : bpy.types.compositornodedilateerode.CompositorNodeDilateErode.Enum1;
	/**
		Growing/shrinking mode
		
		Type: enum in [‘STEP’, ‘THRESHOLD’, ‘DISTANCE’, ‘FEATHER’], default ‘STEP’
	**/
	var mode : bpy.types.compositornodedilateerode.CompositorNodeDilateErode.Enum2;
	/**
