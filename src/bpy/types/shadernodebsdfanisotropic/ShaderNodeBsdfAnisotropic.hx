package bpy.types.shadernodebsdfanisotropic;
@:enum abstract Enum1(String) from String to String {
	var BECKMANN : String = "BECKMANN";
	var GGX : String = "GGX";
	var MULTI_GGX : String = "MULTI_GGX";
	var ASHIKHMIN_SHIRLEY : String = "ASHIKHMIN_SHIRLEY";
}@:pythonImport("bpy.types.ShaderNodeBsdfAnisotropic") extern class ShaderNodeBsdfAnisotropic {
	/**
		
		
		Type: enum in [‘BECKMANN’, ‘GGX’, ‘MULTI_GGX’, ‘ASHIKHMIN_SHIRLEY’], default ‘BECKMANN’
	**/
	var distribution : bpy.types.shadernodebsdfanisotropic.ShaderNodeBsdfAnisotropic.Enum1;
	/**
