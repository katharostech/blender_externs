package bpy.types.compositornodeviewer;
@:enum abstract Enum1(String) from String to String {
	var CENTEROUT : String = "CENTEROUT";
	var RANDOM : String = "RANDOM";
	var BOTTOMUP : String = "BOTTOMUP";
	var RULE_OF_THIRDS : String = "RULE_OF_THIRDS";
}@:pythonImport("bpy.types.CompositorNodeViewer") extern class CompositorNodeViewer {
	/**
	...
	**/
	var tile_order : bpy.types.compositornodeviewer.CompositorNodeViewer.Enum1;
	/**
