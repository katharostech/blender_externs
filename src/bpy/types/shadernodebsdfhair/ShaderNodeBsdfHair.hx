package bpy.types.shadernodebsdfhair;
@:enum abstract Enum1(String) from String to String {
	var R : String = "R";
	var T : String = "T";
}@:pythonImport("bpy.types.ShaderNodeBsdfHair") extern class ShaderNodeBsdfHair {
	/**
		
		
		Type: enum in [‘Reflection’, ‘Transmission’], default ‘Reflection’
	**/
	var component : bpy.types.shadernodebsdfhair.ShaderNodeBsdfHair.Enum1;
	/**
