...
**/
@:native("bpy.types.bpy_struct") extern class Bpy_struct {
	/**
		Returns the memory address which holds a pointer to blenders internal data
		
		@returns int
	**/
	function as_pointer():Int;
	/**
	...
	**/
	function driver_add(path:String, index:Int):bpy.types.fcurve.FCurve;
	/**
		...
		@returns boolean
	**/
	function driver_remove(path:String, index:Int):Bool;
	/**
	...
	**/
	...
	/**
		...
		@returns boolean
	**/
	function is_property_hidden(property:Dynamic):Bool;
	/**
		Check if a property is statically overridable.
		
		@returns boolean
	**/
	function is_property_overridable_static(property:Dynamic):Bool;
	/**
		Check if a property is readonly.
		
		@returns boolean
	**/
	function is_property_readonly(property:Dynamic):Bool;
	/**
		Check if a property is set, use for testing operator properties.
		
		@returns boolean
	**/
	function is_property_set(property:Dynamic):Bool;
	/**
	...
	**/
	...
	/**
		...
		@returns boolean
	**/
	function keyframe_delete(data_path:String, index:Int, frame:Float, group:Dynamic):Bool;
	/**
		...
		@returns boolean
	**/
	function keyframe_insert(data_path:String, index:Int, frame:Float, group:Dynamic, options:Dynamic):Bool;
	/**
	...
	**/
	...
	/**
		...
		@returns str
	**/
	function path_from_id(property:String):Dynamic;
	/**
	...
	**/
	function path_resolve(path:String, coerce:Bool):Void;
	/**
	...
	**/
	...
	/**
		...
		@returns boolean
	**/
	function property_overridable_static_set(property:Dynamic):Bool;
	/**
		Unset a property, will use default value afterward.
	**/
	function property_unset(property:Dynamic):Void;
	/**
	...
	**/
	function type_recast():bpy.types.bpy_struct.Bpy_struct;
	/**
