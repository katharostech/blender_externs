package bpy.types.shadernodescript;
@:enum abstract Enum1(String) from String to String {
	var INTERNAL : String = "INTERNAL";
	var EXTERNAL : String = "EXTERNAL";
}@:pythonImport("bpy.types.ShaderNodeScript") extern class ShaderNodeScript {
	/**
	...
	**/
	var mode : bpy.types.shadernodescript.ShaderNodeScript.Enum1;
	/**
