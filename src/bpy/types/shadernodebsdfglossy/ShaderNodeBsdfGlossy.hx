package bpy.types.shadernodebsdfglossy;
...
}@:pythonImport("bpy.types.ShaderNodeBsdfGlossy") extern class ShaderNodeBsdfGlossy {
	/**
		
		
		Type: enum in [‘SHARP’, ‘BECKMANN’, ‘GGX’, ‘ASHIKHMIN_SHIRLEY’, ‘MULTI_GGX’], default ‘BECKMANN’
	**/
	var distribution : bpy.types.shadernodebsdfglossy.ShaderNodeBsdfGlossy.Enum1;
	/**
