package bpy.types.armatureconstraint;
/**
...
@:native("bpy.types.ArmatureConstraint") extern class ArmatureConstraint {
	...
	**/
	var targets(default, never) : bpy.types.armatureconstrainttargets.ArmatureConstraintTargets;
	/**
