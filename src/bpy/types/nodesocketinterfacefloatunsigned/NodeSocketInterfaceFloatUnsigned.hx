package bpy.types.nodesocketinterfacefloatunsigned;
/**
	Floating point number socket of a node
**/
@:pythonImport("bpy.types.NodeSocketInterfaceFloatUnsigned") extern class NodeSocketInterfaceFloatUnsigned {
	/**
