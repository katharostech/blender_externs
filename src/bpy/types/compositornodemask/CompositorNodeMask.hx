package bpy.types.compositornodemask;
@:enum abstract Enum1(String) from String to String {
	var SCENE : String = "SCENE";
	var FIXED : String = "FIXED";
	var FIXED_SCENE : String = "FIXED_SCENE";
}@:pythonImport("bpy.types.CompositorNodeMask") extern class CompositorNodeMask {
	/**
	...
	**/
	var size_source : bpy.types.compositornodemask.CompositorNodeMask.Enum1;
	/**
