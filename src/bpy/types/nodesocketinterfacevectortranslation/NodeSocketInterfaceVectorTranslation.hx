package bpy.types.nodesocketinterfacevectortranslation;
/**
	3D vector socket of a node
**/
@:pythonImport("bpy.types.NodeSocketInterfaceVectorTranslation") extern class NodeSocketInterfaceVectorTranslation {
	/**
