package bpy.types.compositornodedefocus;
@:enum abstract Enum1(String) from String to String {
	var OCTAGON : String = "OCTAGON";
	var HEPTAGON : String = "HEPTAGON";
	var HEXAGON : String = "HEXAGON";
	var PENTAGON : String = "PENTAGON";
	var SQUARE : String = "SQUARE";
	var TRIANGLE : String = "TRIANGLE";
	var CIRCLE : String = "CIRCLE";
}@:pythonImport("bpy.types.CompositorNodeDefocus") extern class CompositorNodeDefocus {
	/**
	...
	**/
	var bokeh : bpy.types.compositornodedefocus.CompositorNodeDefocus.Enum1;
	/**
