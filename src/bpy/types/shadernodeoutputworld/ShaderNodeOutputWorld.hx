package bpy.types.shadernodeoutputworld;
@:enum abstract Enum1(String) from String to String {
	var ALL : String = "ALL";
	var EEVEE : String = "EEVEE";
	var CYCLES : String = "CYCLES";
}@:pythonImport("bpy.types.ShaderNodeOutputWorld") extern class ShaderNodeOutputWorld {
	/**
	...
	**/
	var target : bpy.types.shadernodeoutputworld.ShaderNodeOutputWorld.Enum1;
	/**
