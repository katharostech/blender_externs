package bpy.types.compositornoderotate;
@:enum abstract Enum1(String) from String to String {
	var NEAREST : String = "NEAREST";
	var BILINEAR : String = "BILINEAR";
	var BICUBIC : String = "BICUBIC";
}@:pythonImport("bpy.types.CompositorNodeRotate") extern class CompositorNodeRotate {
	/**
		Method to use to filter rotation
		
		Type: enum in [‘NEAREST’, ‘BILINEAR’, ‘BICUBIC’], default ‘NEAREST’
	**/
	var filter_type : bpy.types.compositornoderotate.CompositorNodeRotate.Enum1;
	/**
