package bpy.types.linestylecolormodifier_creaseangle;
...
**/
@:pythonImport("bpy.types.LineStyleColorModifier_CreaseAngle") extern class LineStyleColorModifier_CreaseAngle {
	/**
	...
	**/
	var blend : bpy.types.linestylecolormodifier_creaseangle.LineStyleColorModifier_CreaseAngle.Enum1;
	/**
	...
	**/
	var type(default, never) : bpy.types.linestylecolormodifier_creaseangle.LineStyleColorModifier_CreaseAngle.Enum2;
	/**
