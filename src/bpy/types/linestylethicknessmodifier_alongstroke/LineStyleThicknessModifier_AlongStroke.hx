package bpy.types.linestylethicknessmodifier_alongstroke;
...
**/
@:pythonImport("bpy.types.LineStyleThicknessModifier_AlongStroke") extern class LineStyleThicknessModifier_AlongStroke {
	/**
		Specify how the modifier value is blended into the base value
		
		Type: enum in [‘MIX’, ‘ADD’, ‘SUBTRACT’, ‘MULTIPLY’, ‘DIVIDE’, ‘DIFFERENCE’, ‘MINIMUM’, ‘MAXIMUM’], default ‘MIX’
	**/
	var blend : bpy.types.linestylethicknessmodifier_alongstroke.LineStyleThicknessModifier_AlongStroke.Enum1;
	/**
	...
	**/
	var mapping : bpy.types.linestylethicknessmodifier_alongstroke.LineStyleThicknessModifier_AlongStroke.Enum2;
	/**
	...
	**/
	var type(default, never) : bpy.types.linestylethicknessmodifier_alongstroke.LineStyleThicknessModifier_AlongStroke.Enum3;
	/**
