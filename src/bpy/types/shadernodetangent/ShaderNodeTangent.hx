package bpy.types.shadernodetangent;
@:enum abstract Enum1(String) from String to String {
	...
	var UV_MAP : String = "UV_MAP";
}@:pythonImport("bpy.types.ShaderNodeTangent") extern class ShaderNodeTangent {
	/**
		Axis for radial tangents
		
		Type: enum in [‘X’, ‘Y’, ‘Z’], default ‘X’
	**/
	var axis : bpy.types.shadernodetangent.ShaderNodeTangent.Enum1;
	/**
		Method to use for the tangent
		
		Type: enum in [‘RADIAL’, ‘UV_MAP’], default ‘RADIAL’
	**/
	var direction_type : bpy.types.shadernodetangent.ShaderNodeTangent.Enum2;
	/**
