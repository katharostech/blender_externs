...
@:enum abstract Enum1(String) from String to String {
	...
	var PIXEL : String = "PIXEL";
	var UNSIGNED : String = "UNSIGNED";
	...
	var MASS : String = "MASS";
	var CAMERA : String = "CAMERA";
}/**
	RNA property definition
**/
@:pythonImport("bpy.types.Property") extern class Property {
	/**
