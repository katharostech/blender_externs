...
@:enum abstract Enum1(String) from String to String {
	...
	var PARTICLE_VELOCITY : String = "PARTICLE_VELOCITY";
	...
	**/
	var interpolation : bpy.types.shadernodetexpointdensity.ShaderNodeTexPointDensity.Enum1;
	/**
	...
	**/
	var particle_color_source : bpy.types.shadernodetexpointdensity.ShaderNodeTexPointDensity.Enum2;
	/**
	...
	**/
	var point_source : bpy.types.shadernodetexpointdensity.ShaderNodeTexPointDensity.Enum3;
	/**
	...
	**/
	var space : bpy.types.shadernodetexpointdensity.ShaderNodeTexPointDensity.Enum4;
	/**
		Vertex attribute to use for color
		
		Type: string, default “”, (never None)
	**/
	var vertex_attribute_name : String;
	/**
		Data to derive color results from
		
		Type: enum in [‘VERTEX_COLOR’, ‘VERTEX_WEIGHT’, ‘VERTEX_NORMAL’], default ‘VERTEX_COLOR’
	**/
	var vertex_color_source : bpy.types.shadernodetexpointdensity.ShaderNodeTexPointDensity.Enum5;
	/**
