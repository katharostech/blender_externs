package bpy.types.compositornodetransform;
@:enum abstract Enum1(String) from String to String {
	var NEAREST : String = "NEAREST";
	var BILINEAR : String = "BILINEAR";
	var BICUBIC : String = "BICUBIC";
}@:pythonImport("bpy.types.CompositorNodeTransform") extern class CompositorNodeTransform {
	/**
		Method to use to filter transform
		
		Type: enum in [‘NEAREST’, ‘BILINEAR’, ‘BICUBIC’], default ‘NEAREST’
	**/
	var filter_type : bpy.types.compositornodetransform.CompositorNodeTransform.Enum1;
	/**
