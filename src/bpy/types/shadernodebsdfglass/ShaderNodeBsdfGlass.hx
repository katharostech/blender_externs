package bpy.types.shadernodebsdfglass;
@:enum abstract Enum1(String) from String to String {
	var SHARP : String = "SHARP";
	var BECKMANN : String = "BECKMANN";
	var GGX : String = "GGX";
	var MULTI_GGX : String = "MULTI_GGX";
}@:pythonImport("bpy.types.ShaderNodeBsdfGlass") extern class ShaderNodeBsdfGlass {
	/**
		
		
		Type: enum in [‘SHARP’, ‘BECKMANN’, ‘GGX’, ‘MULTI_GGX’], default ‘BECKMANN’
	**/
	var distribution : bpy.types.shadernodebsdfglass.ShaderNodeBsdfGlass.Enum1;
	/**
