package bpy.types.shadernodevectortransform;
...
}@:pythonImport("bpy.types.ShaderNodeVectorTransform") extern class ShaderNodeVectorTransform {
	/**
		Space to convert from
		
		Type: enum in [‘WORLD’, ‘OBJECT’, ‘CAMERA’], default ‘WORLD’
	**/
	var convert_from : bpy.types.shadernodevectortransform.ShaderNodeVectorTransform.Enum1;
	/**
		Space to convert to
		
		Type: enum in [‘WORLD’, ‘OBJECT’, ‘CAMERA’], default ‘WORLD’
	**/
	var convert_to : bpy.types.shadernodevectortransform.ShaderNodeVectorTransform.Enum2;
	/**
		
		
		Type: enum in [‘POINT’, ‘VECTOR’, ‘NORMAL’], default ‘VECTOR’
	**/
	var vector_type : bpy.types.shadernodevectortransform.ShaderNodeVectorTransform.Enum3;
	/**
