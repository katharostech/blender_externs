package bpy.types.smokemodifier;
...
**/
@:pythonImport("bpy.types.SmokeModifier") extern class SmokeModifier {
	/**
		
		
		Type: SmokeCollSettings, (readonly)
	**/
	var coll_settings(default, never) : bpy.types.smokecollsettings.SmokeCollSettings;
	/**
		
		
		Type: SmokeDomainSettings, (readonly)
	**/
	var domain_settings(default, never) : bpy.types.smokedomainsettings.SmokeDomainSettings;
	/**
		
		
		Type: SmokeFlowSettings, (readonly)
	**/
	var flow_settings(default, never) : bpy.types.smokeflowsettings.SmokeFlowSettings;
	/**
		
		
		Type: enum in [‘NONE’, ‘DOMAIN’, ‘FLOW’, ‘COLLISION’], default ‘NONE’
	**/
	var smoke_type : bpy.types.smokemodifier.SmokeModifier.Enum1;
	/**
