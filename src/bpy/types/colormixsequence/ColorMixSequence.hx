package bpy.types.colormixsequence;
@:enum abstract Enum1(String) from String to String {
	...
	Color Mix Sequence
**/
@:pythonImport("bpy.types.ColorMixSequence") extern class ColorMixSequence {
	/**
	...
	**/
	var blend_effect : bpy.types.colormixsequence.ColorMixSequence.Enum1;
	/**
