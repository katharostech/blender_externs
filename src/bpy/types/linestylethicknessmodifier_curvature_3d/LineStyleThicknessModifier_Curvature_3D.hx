package bpy.types.linestylethicknessmodifier_curvature_3d;
...
**/
@:pythonImport("bpy.types.LineStyleThicknessModifier_Curvature_3D") extern class LineStyleThicknessModifier_Curvature_3D {
	/**
		Specify how the modifier value is blended into the base value
		
		Type: enum in [‘MIX’, ‘ADD’, ‘SUBTRACT’, ‘MULTIPLY’, ‘DIVIDE’, ‘DIFFERENCE’, ‘MINIMUM’, ‘MAXIMUM’], default ‘MIX’
	**/
	var blend : bpy.types.linestylethicknessmodifier_curvature_3d.LineStyleThicknessModifier_Curvature_3D.Enum1;
	/**
		Maximum Curvature
		
		Type: float in [0, 10000], default 0.0
	**/
	var curvature_max : Float;
	/**
		Minimum Curvature
		
		Type: float in [0, 10000], default 0.0
	**/
	var curvature_min : Float;
	/**
	...
	**/
	var mapping : bpy.types.linestylethicknessmodifier_curvature_3d.LineStyleThicknessModifier_Curvature_3D.Enum2;
	/**
	...
	**/
	var type(default, never) : bpy.types.linestylethicknessmodifier_curvature_3d.LineStyleThicknessModifier_Curvature_3D.Enum3;
	/**
