package bpy.types.compositornodecolorspill;
@:enum abstract Enum1(String) from String to String {
...
}@:pythonImport("bpy.types.CompositorNodeColorSpill") extern class CompositorNodeColorSpill {
	/**
		
		
		Type: enum in [‘R’, ‘G’, ‘B’], default ‘R’
	**/
	var channel : bpy.types.compositornodecolorspill.CompositorNodeColorSpill.Enum1;
	/**
		
		
		Type: enum in [‘R’, ‘G’, ‘B’], default ‘R’
	**/
	var limit_channel : bpy.types.compositornodecolorspill.CompositorNodeColorSpill.Enum2;
	/**
		
		
		Type: enum in [‘SIMPLE’, ‘AVERAGE’], default ‘SIMPLE’
	**/
	var limit_method : bpy.types.compositornodecolorspill.CompositorNodeColorSpill.Enum3;
	/**
	...
	**/
	var unspill_blue : Float;
	/**
		Green spillmap scale
		
		Type: float in [0, 1.5], default 0.0
	**/
	var unspill_green : Float;
	/**
		Red spillmap scale
		
		Type: float in [0, 1.5], default 0.0
	**/
	var unspill_red : Float;
	/**
		Compensate all channels (differently) by hand
		
		Type: boolean, default False
	**/
	var use_unspill : Bool;
	/**
