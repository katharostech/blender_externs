package bpy.types.shadernodemapping;
@:enum abstract Enum1(String) from String to String {
	var TEXTURE : String = "TEXTURE";
	var POINT : String = "POINT";
	var VECTOR : String = "VECTOR";
	var NORMAL : String = "NORMAL";
}@:pythonImport("bpy.types.ShaderNodeMapping") extern class ShaderNodeMapping {
	/**
	...
	**/
	var vector_type : bpy.types.shadernodemapping.ShaderNodeMapping.Enum1;
	/**
