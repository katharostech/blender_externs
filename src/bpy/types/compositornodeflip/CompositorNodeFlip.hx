package bpy.types.compositornodeflip;
@:enum abstract Enum1(String) from String to String {
	var X : String = "X";
	var Y : String = "Y";
	var XY : String = "XY";
}@:pythonImport("bpy.types.CompositorNodeFlip") extern class CompositorNodeFlip {
	/**
		
		
		Type: enum in [‘X’, ‘Y’, ‘XY’], default ‘X’
	**/
	var axis : bpy.types.compositornodeflip.CompositorNodeFlip.Enum1;
	/**
