package bpy.types.floorconstraint;
@:enum abstract Enum1(String) from String to String {
	var FLOOR_X : String = "FLOOR_X";
	var FLOOR_Y : String = "FLOOR_Y";
	var FLOOR_Z : String = "FLOOR_Z";
	var FLOOR_NEGATIVE_X : String = "FLOOR_NEGATIVE_X";
	var FLOOR_NEGATIVE_Y : String = "FLOOR_NEGATIVE_Y";
	var FLOOR_NEGATIVE_Z : String = "FLOOR_NEGATIVE_Z";
}/**
...
@:pythonImport("bpy.types.FloorConstraint") extern class FloorConstraint {
	...
	**/
	var floor_location : bpy.types.floorconstraint.FloorConstraint.Enum1;
	/**
