package bpy.types.cloudstexture;
...
**/
@:pythonImport("bpy.types.CloudsTexture") extern class CloudsTexture {
	/**
		Determine whether Noise returns grayscale or RGB values
		
		Type: enum in [‘GRAYSCALE’, ‘COLOR’], default ‘GRAYSCALE’
	**/
	var cloud_type : bpy.types.cloudstexture.CloudsTexture.Enum1;
	/**
	...
	**/
	var noise_basis : bpy.types.cloudstexture.CloudsTexture.Enum2;
	/**
	...
	**/
	var noise_type : bpy.types.cloudstexture.CloudsTexture.Enum3;
	/**
