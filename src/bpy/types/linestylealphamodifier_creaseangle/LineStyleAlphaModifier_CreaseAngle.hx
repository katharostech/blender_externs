package bpy.types.linestylealphamodifier_creaseangle;
...
**/
@:pythonImport("bpy.types.LineStyleAlphaModifier_CreaseAngle") extern class LineStyleAlphaModifier_CreaseAngle {
	/**
	...
	**/
	var blend : bpy.types.linestylealphamodifier_creaseangle.LineStyleAlphaModifier_CreaseAngle.Enum1;
	/**
	...
	**/
	var mapping : bpy.types.linestylealphamodifier_creaseangle.LineStyleAlphaModifier_CreaseAngle.Enum2;
	/**
	...
	**/
	var type(default, never) : bpy.types.linestylealphamodifier_creaseangle.LineStyleAlphaModifier_CreaseAngle.Enum3;
	/**
