package bpy.types.compositornodeellipsemask;
@:enum abstract Enum1(String) from String to String {
	var ADD : String = "ADD";
	var SUBTRACT : String = "SUBTRACT";
	var MULTIPLY : String = "MULTIPLY";
	var NOT : String = "NOT";
}@:pythonImport("bpy.types.CompositorNodeEllipseMask") extern class CompositorNodeEllipseMask {
	/**
	...
	**/
	var mask_type : bpy.types.compositornodeellipsemask.CompositorNodeEllipseMask.Enum1;
	/**
