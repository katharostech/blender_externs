...
@:pythonImport("bpy.types.FloatProperty") extern class FloatProperty {
	...
	**/
	var type(default, never) : bpy.types.property.Property.Enum3;
	/**
	...
	**/
	...
	/**
		...
		Type: boolean, default False, (readonly)
	**/
	var is_skip_save(default, never) : Bool;
	/**
