...
**/
@:native("bpy.types.LineStyleAlphaModifiers") extern class LineStyleAlphaModifiers {
	/**
	...
	**/
	function pyNew(name:String, type:bpy.types.linestylealphamodifiers.LineStyleAlphaModifiers.Enum1):bpy.types.linestylealphamodifier.LineStyleAlphaModifier;
	/**
