package bpy.types.texturenodemath;
@:enum abstract Enum1(String) from String to String {
...
}@:pythonImport("bpy.types.TextureNodeMath") extern class TextureNodeMath {
	/**
	...
	**/
	var operation : bpy.types.texturenodemath.TextureNodeMath.Enum1;
	/**
