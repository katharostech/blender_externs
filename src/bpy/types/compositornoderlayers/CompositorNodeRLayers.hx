package bpy.types.compositornoderlayers;
@:enum abstract Enum1(String) from String to String {
	var PLACEHOLDER : String = "PLACEHOLDER";
}@:pythonImport("bpy.types.CompositorNodeRLayers") extern class CompositorNodeRLayers {
	/**
		
		
		Type: enum in [‘PLACEHOLDER’], default ‘PLACEHOLDER’
	**/
	var layer : bpy.types.compositornoderlayers.CompositorNodeRLayers.Enum1;
	/**
