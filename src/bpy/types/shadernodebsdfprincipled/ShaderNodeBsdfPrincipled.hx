package bpy.types.shadernodebsdfprincipled;
@:enum abstract Enum1(String) from String to String {
	var GGX : String = "GGX";
	var MULTI_GGX : String = "MULTI_GGX";
}@:enum abstract Enum2(String) from String to String {
	var BURLEY : String = "BURLEY";
	var RANDOM_WALK : String = "RANDOM_WALK";
}@:pythonImport("bpy.types.ShaderNodeBsdfPrincipled") extern class ShaderNodeBsdfPrincipled {
	/**
		
		
		Type: enum in [‘GGX’, ‘MULTI_GGX’], default ‘GGX’
	**/
	var distribution : bpy.types.shadernodebsdfprincipled.ShaderNodeBsdfPrincipled.Enum1;
	/**
		Method for rendering subsurface scattering
		
		Type: enum in [‘BURLEY’, ‘RANDOM_WALK’], default ‘BURLEY’
	**/
	var subsurface_method : bpy.types.shadernodebsdfprincipled.ShaderNodeBsdfPrincipled.Enum2;
	/**
