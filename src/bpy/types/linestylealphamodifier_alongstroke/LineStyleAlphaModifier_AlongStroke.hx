package bpy.types.linestylealphamodifier_alongstroke;
...
**/
@:pythonImport("bpy.types.LineStyleAlphaModifier_AlongStroke") extern class LineStyleAlphaModifier_AlongStroke {
	/**
		Specify how the modifier value is blended into the base value
		
		Type: enum in [‘MIX’, ‘ADD’, ‘SUBTRACT’, ‘MULTIPLY’, ‘DIVIDE’, ‘DIFFERENCE’, ‘MINIMUM’, ‘MAXIMUM’], default ‘MIX’
	**/
	var blend : bpy.types.linestylealphamodifier_alongstroke.LineStyleAlphaModifier_AlongStroke.Enum1;
	/**
	...
	**/
	var mapping : bpy.types.linestylealphamodifier_alongstroke.LineStyleAlphaModifier_AlongStroke.Enum2;
	/**
	...
	**/
	var type(default, never) : bpy.types.linestylealphamodifier_alongstroke.LineStyleAlphaModifier_AlongStroke.Enum3;
	/**
