package bpy.types.themespacegradient;
@:pythonImport("bpy.types.ThemeSpaceGradient") extern class ThemeSpaceGradient {
	/**
	...
	**/
	var gradients(default, never) : bpy.types.themegradientcolors.ThemeGradientColors;
	/**
