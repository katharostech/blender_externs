package bpy.types.compositornodehuecorrect;
@:pythonImport("bpy.types.CompositorNodeHueCorrect") extern class CompositorNodeHueCorrect {
	/**
		
		
		Type: CurveMapping, (readonly)
	**/
	var mapping(default, never) : bpy.types.curvemapping.CurveMapping;
	/**
