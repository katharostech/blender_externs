package bpy.types.shadernodevectormath;
@:enum abstract Enum1(String) from String to String {
	var ADD : String = "ADD";
	var SUBTRACT : String = "SUBTRACT";
	var AVERAGE : String = "AVERAGE";
	var DOT_PRODUCT : String = "DOT_PRODUCT";
	var CROSS_PRODUCT : String = "CROSS_PRODUCT";
	var NORMALIZE : String = "NORMALIZE";
}@:pythonImport("bpy.types.ShaderNodeVectorMath") extern class ShaderNodeVectorMath {
	/**
		
		
		Type: enum in [‘ADD’, ‘SUBTRACT’, ‘AVERAGE’, ‘DOT_PRODUCT’, ‘CROSS_PRODUCT’, ‘NORMALIZE’], default ‘ADD’
	**/
	var operation : bpy.types.shadernodevectormath.ShaderNodeVectorMath.Enum1;
	/**
