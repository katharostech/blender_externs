package bpy.types.vertexweighteditmodifier;
...
**/
@:pythonImport("bpy.types.VertexWeightEditModifier") extern class VertexWeightEditModifier {
	/**
		Lower bound for a vertex’s weight to be added to the vgroup
		
		Type: float in [0, 1], default 0.0
	**/
	var add_threshold : Float;
	/**
	...
	**/
	var falloff_type : bpy.types.vertexweighteditmodifier.VertexWeightEditModifier.Enum1;
	/**
		Custom mapping curve
		
		Type: CurveMapping, (readonly)
	**/
	var map_curve(default, never) : bpy.types.curvemapping.CurveMapping;
	/**
	...
	**/
	var mask_tex_mapping : bpy.types.vertexweighteditmodifier.VertexWeightEditModifier.Enum2;
	/**
		Which texture channel to use for masking
		
		Type: enum in [‘INT’, ‘RED’, ‘GREEN’, ‘BLUE’, ‘HUE’, ‘SAT’, ‘VAL’, ‘ALPHA’], default ‘INT’
	**/
	var mask_tex_use_channel : bpy.types.vertexweighteditmodifier.VertexWeightEditModifier.Enum3;
	/**
		UV map name
