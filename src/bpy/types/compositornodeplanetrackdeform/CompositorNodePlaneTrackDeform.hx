package bpy.types.compositornodeplanetrackdeform;
@:pythonImport("bpy.types.CompositorNodePlaneTrackDeform") extern class CompositorNodePlaneTrackDeform {
	/**
