package bpy.types.compositornodesplitviewer;
@:enum abstract Enum1(String) from String to String {
	var X : String = "X";
	var Y : String = "Y";
}@:pythonImport("bpy.types.CompositorNodeSplitViewer") extern class CompositorNodeSplitViewer {
	/**
		
		
		Type: enum in [‘X’, ‘Y’], default ‘X’
	**/
	var axis : bpy.types.compositornodesplitviewer.CompositorNodeSplitViewer.Enum1;
	/**
