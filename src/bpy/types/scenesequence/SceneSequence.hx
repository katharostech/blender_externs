package bpy.types.scenesequence;
...
@:pythonImport("bpy.types.SceneSequence") extern class SceneSequence {
	...
	**/
	var alpha_mode : bpy.types.scenesequence.SceneSequence.Enum1;
	/**
	...
	**/
	...
	/**
		...
		Type: Object
	**/
	var scene_camera : bpy.types.object.Object;
	/**
