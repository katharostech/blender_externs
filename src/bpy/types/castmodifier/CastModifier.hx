package bpy.types.castmodifier;
@:enum abstract Enum1(String) from String to String {
	var SPHERE : String = "SPHERE";
	var CYLINDER : String = "CYLINDER";
	var CUBOID : String = "CUBOID";
}/**
	Modifier to cast to other shapes
**/
@:pythonImport("bpy.types.CastModifier") extern class CastModifier {
	/**
		Target object shape
		
		Type: enum in [‘SPHERE’, ‘CYLINDER’, ‘CUBOID’], default ‘SPHERE’
	**/
	var cast_type : bpy.types.castmodifier.CastModifier.Enum1;
	/**
	...
	**/
	var use_radius_as_size : Bool;
	/**
		Use object transform to control projection shape
		
		Type: boolean, default False
	**/
	var use_transform : Bool;
	/**
