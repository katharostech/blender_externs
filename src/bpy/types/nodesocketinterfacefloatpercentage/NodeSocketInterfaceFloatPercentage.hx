package bpy.types.nodesocketinterfacefloatpercentage;
/**
	Floating point number socket of a node
**/
@:pythonImport("bpy.types.NodeSocketInterfaceFloatPercentage") extern class NodeSocketInterfaceFloatPercentage {
	/**
