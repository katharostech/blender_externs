...
**/
@:pythonImport("bpy.types.UILayout") extern class UILayout {
	/**
	...
	**/
	function context_pointer_set(name:String, data:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		@param data Data from which to take property — AnyType, (never None)
		@param property Identifier of property in data — string, (never None)
		@param new Operator identifier to create a new ID block — string, (optional, never None)
	...
	**/
	function template_ID(data:bpy.types.anytype.AnyType, property:String, new:String, open:String, unlink:String, filter:bpy.types.uilayout.UILayout.Enum16, live_icon:Bool):Void;
	/**
		template_ID_preview
		@param data Data from which to take property — AnyType, (never None)
		@param property Identifier of property in data — string, (never None)
	...
	**/
	function template_ID_preview(data:bpy.types.anytype.AnyType, property:String, new:String, open:String, unlink:String, rows:Int, cols:Int, filter:bpy.types.uilayout.UILayout.Enum17, hide_buttons:Bool):Void;
	/**
		template_any_ID
		@param data Data from which to take property — AnyType, (never None)
		@param property Identifier of property in data — string, (never None)
	...
	**/
	...
	/**
		...
		@param filter Optionally limit the items which can be selected — enum in ['ALL', 'AVAILABLE'], (optional)
	**/
	function template_ID_tabs(data:bpy.types.anytype.AnyType, property:String, new:String, menu:String, filter:bpy.types.uilayout.UILayout.Enum18):Void;
	/**
		template_search
		@param data Data from which to take property — AnyType, (never None)
		@param property Identifier of property in data — string, (never None)
		@param search_data Data from which to take collection to search in — AnyType, (never None)
		@param search_property Identifier of search collection property — string, (never None)
		@param new Operator identifier to create a new item for the collection — string, (optional, never None)
		@param unlink Operator identifier to unlink or delete the active item from the collection — string, (optional, never None)
	**/
	function template_search(data:bpy.types.anytype.AnyType, property:String, search_data:bpy.types.anytype.AnyType, search_property:String, new:String, unlink:String):Void;
	/**
		...
		@param cols Number of thumbnail preview columns to display — int in [0, inf], (optional)
	**/
	function template_search_preview(data:bpy.types.anytype.AnyType, property:String, search_data:bpy.types.anytype.AnyType, search_property:String, new:String, unlink:String, rows:Int, cols:Int):Void;
	/**
		...
		@param translate Translate the given text, when UI translation is enabled — boolean, (optional)
	**/
	function template_path_builder(data:bpy.types.anytype.AnyType, property:String, root:Dynamic, text:String, text_ctxt:String, translate:Bool):Void;
	/**
	...
	**/
	function template_preview(id:Dynamic, show_buttons:Bool, parent:bpy.types.id.ID, slot:bpy.types.textureslot.TextureSlot, preview_id:String):Void;
	/**
	...
	**/
	function template_layers(data:bpy.types.anytype.AnyType, property:String, used_layers_data:Dynamic, used_layers_property:String, active_layer:Int):Void;
	/**
	...
	**/
	function template_image_layers():Void;
	/**
	...
	**/
	function template_image_stereo_3d():Void;
	/**
		User interface for setting image views output options
	**/
	function template_image_views():Void;
	/**
	...
	**/
	function template_list(listtype_name:String, list_id:String, dataptr:Dynamic, propname:String, active_dataptr:bpy.types.anytype.AnyType, active_propname:String, item_dyntip_propname:String, rows:Int, maxrows:Int, type:bpy.types.uilayout.UILayout.Enum21, columns:Int, reverse:Bool):Void;
	/**
	...
	**/
	function template_header_3D():Void;
	function template_header_3D_mode():Void;
	/**
	...
	**/
	...
	/**
		template_node_link
	**/
	function template_node_link():Void;
	/**
		template_node_view
	**/
	function template_node_view():Void;
	/**
	...
	**/
	function template_keymap_item_properties():Void;
	/**
		Item. Display expanded property in a popup menu
		@param data Data from which to take property — AnyType
		@param property Identifier of property in data — string, (never None)
	**/
	function template_component_menu(data:Dynamic, property:String):Void;
	/**
