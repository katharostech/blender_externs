...
@:pythonImport("bpy.types.Key") extern class Key {
	...
	**/
	var key_blocks(default, never) : bpy.types.bpy_prop_collection.Bpy_prop_collection;
	/**
		
		
		Type: ShapeKey, (readonly, never None)
	**/
	var reference_key(default, never) : bpy.types.shapekey.ShapeKey;
	/**
	...
	**/
	var user(default, never) : bpy.types.id.ID;
	/**
