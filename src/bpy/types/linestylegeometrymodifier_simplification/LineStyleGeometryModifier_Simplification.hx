package bpy.types.linestylegeometrymodifier_simplification;
...
**/
@:native("bpy.types.LineStyleGeometryModifier_Simplification") extern class LineStyleGeometryModifier_Simplification {
	/**
	...
	**/
	var type(default, never) : bpy.types.linestylegeometrymodifier_simplification.LineStyleGeometryModifier_Simplification.Enum1;
	/**
