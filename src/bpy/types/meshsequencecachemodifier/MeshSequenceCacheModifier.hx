package bpy.types.meshsequencecachemodifier;
/**
	Cache Mesh
**/
@:pythonImport("bpy.types.MeshSequenceCacheModifier") extern class MeshSequenceCacheModifier {
	/**
		
		
		Type: CacheFile
	**/
	var cache_file : bpy.types.cachefile.CacheFile;
	/**
