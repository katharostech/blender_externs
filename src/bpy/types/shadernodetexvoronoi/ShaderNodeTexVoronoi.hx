package bpy.types.shadernodetexvoronoi;
@:enum abstract Enum1(String) from String to String {
	...
	var MINKOWSKI : String = "MINKOWSKI";
}@:enum abstract Enum3(String) from String to String {
	var F1 : String = "F1";
	var F2 : String = "F2";
	var F3 : String = "F3";
	var F4 : String = "F4";
	var F2F1 : String = "F2F1";
}@:pythonImport("bpy.types.ShaderNodeTexVoronoi") extern class ShaderNodeTexVoronoi {
	/**
	...
	**/
	var coloring : bpy.types.shadernodetexvoronoi.ShaderNodeTexVoronoi.Enum1;
	/**
		
		
		Type: enum in [‘DISTANCE’, ‘MANHATTAN’, ‘CHEBYCHEV’, ‘MINKOWSKI’], default ‘DISTANCE’
	**/
	var distance : bpy.types.shadernodetexvoronoi.ShaderNodeTexVoronoi.Enum2;
	/**
		
		
		Type: enum in [‘F1’, ‘F2’, ‘F3’, ‘F4’, ‘F2F1’], default ‘F1’
	**/
	var feature : bpy.types.shadernodetexvoronoi.ShaderNodeTexVoronoi.Enum3;
	/**
