package bpy.types.softbodymodifier;
/**
	Soft body simulation modifier
**/
@:pythonImport("bpy.types.SoftBodyModifier") extern class SoftBodyModifier {
	/**
	...
	**/
	var settings(default, never) : bpy.types.softbodysettings.SoftBodySettings;
	/**
