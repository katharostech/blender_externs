package bpy.types.musgravetexture;
...
**/
@:pythonImport("bpy.types.MusgraveTexture") extern class MusgraveTexture {
	/**
		Highest fractal dimension
		
		Type: float in [0.0001, 2], default 0.0
	**/
	var dimension_max : Float;
	/**
		The gain multiplier
	...
	**/
	var musgrave_type : bpy.types.musgravetexture.MusgraveTexture.Enum1;
	/**
	...
	**/
	var noise_basis : bpy.types.musgravetexture.MusgraveTexture.Enum2;
	/**
