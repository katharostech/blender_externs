package bpy.types.linestylecolormodifier_noise;
...
**/
@:pythonImport("bpy.types.LineStyleColorModifier_Noise") extern class LineStyleColorModifier_Noise {
	/**
	...
	**/
	var blend : bpy.types.linestylecolormodifier_noise.LineStyleColorModifier_Noise.Enum1;
	/**
	...
	**/
	var type(default, never) : bpy.types.linestylecolormodifier_noise.LineStyleColorModifier_Noise.Enum2;
	/**
