...
@:enum abstract Enum1(String) from String to String {
	...
	var BANDNOISE : String = "BANDNOISE";
	var RINGNOISE : String = "RINGNOISE";
}/**
	Procedural noise texture
**/
@:pythonImport("bpy.types.WoodTexture") extern class WoodTexture {
	/**
	...
	**/
	var noise_basis : bpy.types.woodtexture.WoodTexture.Enum1;
	/**
		
		
		Type: enum in [‘SIN’, ‘SAW’, ‘TRI’], default ‘SIN’
	**/
	var noise_basis_2 : bpy.types.woodtexture.WoodTexture.Enum2;
	/**
	...
	**/
	var noise_type : bpy.types.woodtexture.WoodTexture.Enum3;
	/**
	...
	**/
	var wood_type : bpy.types.woodtexture.WoodTexture.Enum4;
	/**
