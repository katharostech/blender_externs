package bpy.types.shadernodetexmusgrave;
@:enum abstract Enum1(String) from String to String {
	var MULTIFRACTAL : String = "MULTIFRACTAL";
	var RIDGED_MULTIFRACTAL : String = "RIDGED_MULTIFRACTAL";
	var HYBRID_MULTIFRACTAL : String = "HYBRID_MULTIFRACTAL";
	var FBM : String = "FBM";
	var HETERO_TERRAIN : String = "HETERO_TERRAIN";
}@:pythonImport("bpy.types.ShaderNodeTexMusgrave") extern class ShaderNodeTexMusgrave {
	/**
	...
	**/
	var musgrave_type : bpy.types.shadernodetexmusgrave.ShaderNodeTexMusgrave.Enum1;
	/**
