package bpy.types.shadernodetexenvironment;
@:enum abstract Enum1(String) from String to String {
	...
	var MIRROR_BALL : String = "MIRROR_BALL";
}@:pythonImport("bpy.types.ShaderNodeTexEnvironment") extern class ShaderNodeTexEnvironment {
	/**
	...
	**/
	var color_space : bpy.types.shadernodetexenvironment.ShaderNodeTexEnvironment.Enum1;
	/**
	...
	**/
	var interpolation : bpy.types.shadernodetexenvironment.ShaderNodeTexEnvironment.Enum2;
	/**
		Projection of the input image
		
		Type: enum in [‘EQUIRECTANGULAR’, ‘MIRROR_BALL’], default ‘EQUIRECTANGULAR’
	**/
	var projection : bpy.types.shadernodetexenvironment.ShaderNodeTexEnvironment.Enum3;
	/**
