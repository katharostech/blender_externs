package bpy.types.linestylecolormodifier_distancefromcamera;
...
**/
@:pythonImport("bpy.types.LineStyleColorModifier_DistanceFromCamera") extern class LineStyleColorModifier_DistanceFromCamera {
	/**
	...
	**/
	var blend : bpy.types.linestylecolormodifier_distancefromcamera.LineStyleColorModifier_DistanceFromCamera.Enum1;
	/**
	...
	**/
	var type(default, never) : bpy.types.linestylecolormodifier_distancefromcamera.LineStyleColorModifier_DistanceFromCamera.Enum2;
	/**
