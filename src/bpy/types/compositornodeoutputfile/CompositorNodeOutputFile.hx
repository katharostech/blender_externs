package bpy.types.compositornodeoutputfile;
@:pythonImport("bpy.types.CompositorNodeOutputFile") extern class CompositorNodeOutputFile {
	/**
		Active input index in details view list
		
		Type: int in [-inf, inf], default 0
	**/
	var active_input_index : Int;
	/**
	...
	**/
	var file_slots(default, never) : bpy.types.compositornodeoutputfilefileslots.CompositorNodeOutputFileFileSlots;
	/**
	...
	**/
	var layer_slots(default, never) : bpy.types.compositornodeoutputfilelayerslots.CompositorNodeOutputFileLayerSlots;
	/**
