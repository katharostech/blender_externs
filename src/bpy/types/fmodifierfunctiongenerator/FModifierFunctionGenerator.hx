package bpy.types.fmodifierfunctiongenerator;
@:enum abstract Enum1(String) from String to String {
	...
	var LN : String = "LN";
	var SINC : String = "SINC";
}/**
	Generate values using a Built-In Function
**/
@:pythonImport("bpy.types.FModifierFunctionGenerator") extern class FModifierFunctionGenerator {
	/**
	...
	**/
	var function_type : bpy.types.fmodifierfunctiongenerator.FModifierFunctionGenerator.Enum1;
	/**
		Scale factor determining the ‘speed’ of the function
		
		Type: float in [-inf, inf], default 0.0
	**/
	var phase_multiplier : Float;
	/**
