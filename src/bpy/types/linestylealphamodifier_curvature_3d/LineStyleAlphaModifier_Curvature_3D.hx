package bpy.types.linestylealphamodifier_curvature_3d;
...
**/
@:pythonImport("bpy.types.LineStyleAlphaModifier_Curvature_3D") extern class LineStyleAlphaModifier_Curvature_3D {
	/**
		Specify how the modifier value is blended into the base value
		
		Type: enum in [‘MIX’, ‘ADD’, ‘SUBTRACT’, ‘MULTIPLY’, ‘DIVIDE’, ‘DIFFERENCE’, ‘MINIMUM’, ‘MAXIMUM’], default ‘MIX’
	**/
	var blend : bpy.types.linestylealphamodifier_curvature_3d.LineStyleAlphaModifier_Curvature_3D.Enum1;
	/**
		Maximum Curvature
	...
	**/
	var mapping : bpy.types.linestylealphamodifier_curvature_3d.LineStyleAlphaModifier_Curvature_3D.Enum2;
	/**
	...
	**/
	var type(default, never) : bpy.types.linestylealphamodifier_curvature_3d.LineStyleAlphaModifier_Curvature_3D.Enum3;
	/**
