package bpy.types.shadernodetexwave;
@:enum abstract Enum1(String) from String to String {
	var SIN : String = "SIN";
	var SAW : String = "SAW";
}@:enum abstract Enum2(String) from String to String {
	var BANDS : String = "BANDS";
	var RINGS : String = "RINGS";
}@:pythonImport("bpy.types.ShaderNodeTexWave") extern class ShaderNodeTexWave {
	/**
	...
	**/
	var wave_profile : bpy.types.shadernodetexwave.ShaderNodeTexWave.Enum1;
	/**
		
		
		Type: enum in [‘BANDS’, ‘RINGS’], default ‘BANDS’
	**/
	var wave_type : bpy.types.shadernodetexwave.ShaderNodeTexWave.Enum2;
	/**
