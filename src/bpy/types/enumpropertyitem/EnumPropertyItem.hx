package bpy.types.enumpropertyitem;
...
**/
@:pythonImport("bpy.types.EnumPropertyItem") extern class EnumPropertyItem {
	/**
	...
	**/
	var icon(default, never) : bpy.types.enumpropertyitem.EnumPropertyItem.Enum1;
	/**
