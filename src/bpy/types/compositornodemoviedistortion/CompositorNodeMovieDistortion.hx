package bpy.types.compositornodemoviedistortion;
@:enum abstract Enum1(String) from String to String {
	var UNDISTORT : String = "UNDISTORT";
	var DISTORT : String = "DISTORT";
}@:pythonImport("bpy.types.CompositorNodeMovieDistortion") extern class CompositorNodeMovieDistortion {
	/**
	...
	**/
	var distortion_type : bpy.types.compositornodemoviedistortion.CompositorNodeMovieDistortion.Enum1;
	/**
