package bpy.types.compositornodeblur;
@:enum abstract Enum1(String) from String to String {
	...
	var TENT : String = "TENT";
	var QUAD : String = "QUAD";
	var CUBIC : String = "CUBIC";
	var GAUSS : String = "GAUSS";
	var FAST_GAUSS : String = "FAST_GAUSS";
	var CATROM : String = "CATROM";
	var MITCH : String = "MITCH";
}@:pythonImport("bpy.types.CompositorNodeBlur") extern class CompositorNodeBlur {
	/**
		Type of aspect correction to use
		
		Type: enum in [‘NONE’, ‘Y’, ‘X’], default ‘NONE’
	**/
	var aspect_correction : bpy.types.compositornodeblur.CompositorNodeBlur.Enum1;
	/**
	...
	**/
	var filter_type : bpy.types.compositornodeblur.CompositorNodeBlur.Enum2;
	/**
	...
	**/
	...
	/**
		...
		Type: boolean, default False
	**/
	var use_extended_bounds : Bool;
	/**
		Apply filter on gamma corrected values
		
		Type: boolean, default False
	**/
	var use_gamma_correction : Bool;
	/**
