package bpy.types.linestylecolormodifier_distancefromobject;
...
**/
@:pythonImport("bpy.types.LineStyleColorModifier_DistanceFromObject") extern class LineStyleColorModifier_DistanceFromObject {
	/**
	...
	**/
	var blend : bpy.types.linestylecolormodifier_distancefromobject.LineStyleColorModifier_DistanceFromObject.Enum1;
	/**
	...
	**/
	var type(default, never) : bpy.types.linestylecolormodifier_distancefromobject.LineStyleColorModifier_DistanceFromObject.Enum2;
	/**
