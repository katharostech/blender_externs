package bpy.types.compositornodedoubleedgemask;
@:enum abstract Enum1(String) from String to String {
	var BLEED_OUT : String = "BLEED_OUT";
	var KEEP_IN : String = "KEEP_IN";
}@:enum abstract Enum2(String) from String to String {
	var ALL : String = "ALL";
	var ADJACENT_ONLY : String = "ADJACENT_ONLY";
}@:pythonImport("bpy.types.CompositorNodeDoubleEdgeMask") extern class CompositorNodeDoubleEdgeMask {
	/**
		
		
		Type: enum in [‘BLEED_OUT’, ‘KEEP_IN’], default ‘BLEED_OUT’
	**/
	var edge_mode : bpy.types.compositornodedoubleedgemask.CompositorNodeDoubleEdgeMask.Enum1;
	/**
		
		
		Type: enum in [‘ALL’, ‘ADJACENT_ONLY’], default ‘ALL’
	**/
	var inner_mode : bpy.types.compositornodedoubleedgemask.CompositorNodeDoubleEdgeMask.Enum2;
	/**
