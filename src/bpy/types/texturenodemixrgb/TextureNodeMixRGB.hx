package bpy.types.texturenodemixrgb;
@:enum abstract Enum1(String) from String to String {
...
}@:pythonImport("bpy.types.TextureNodeMixRGB") extern class TextureNodeMixRGB {
	/**
	...
	**/
	var blend_type : bpy.types.texturenodemixrgb.TextureNodeMixRGB.Enum1;
	/**
