package bpy.types.linestylethicknessmodifier_tangent;
...
**/
@:pythonImport("bpy.types.LineStyleThicknessModifier_Tangent") extern class LineStyleThicknessModifier_Tangent {
	/**
		Specify how the modifier value is blended into the base value
		
		Type: enum in [‘MIX’, ‘ADD’, ‘SUBTRACT’, ‘MULTIPLY’, ‘DIVIDE’, ‘DIFFERENCE’, ‘MINIMUM’, ‘MAXIMUM’], default ‘MIX’
	**/
	var blend : bpy.types.linestylethicknessmodifier_tangent.LineStyleThicknessModifier_Tangent.Enum1;
	/**
	...
	**/
	var mapping : bpy.types.linestylethicknessmodifier_tangent.LineStyleThicknessModifier_Tangent.Enum2;
	/**
	...
	**/
	var type(default, never) : bpy.types.linestylethicknessmodifier_tangent.LineStyleThicknessModifier_Tangent.Enum3;
	/**
