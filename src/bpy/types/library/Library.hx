package bpy.types.library;
/**
	External .blend file from which data is linked
**/
@:pythonImport("bpy.types.Library") extern class Library {
	/**
	...
	**/
	var parent(default, never) : bpy.types.library.Library;
	/**
		ID data blocks which use this library
		(readonly)
	**/
	var users_id(default, never) : Dynamic;
	/**
