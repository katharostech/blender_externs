package bpy.types.compositornodetranslate;
@:enum abstract Enum1(String) from String to String {
	var NONE : String = "NONE";
	var XAXIS : String = "XAXIS";
	var YAXIS : String = "YAXIS";
	var BOTH : String = "BOTH";
}@:pythonImport("bpy.types.CompositorNodeTranslate") extern class CompositorNodeTranslate {
	/**
	...
	**/
	var wrap_axis : bpy.types.compositornodetranslate.CompositorNodeTranslate.Enum1;
	/**
