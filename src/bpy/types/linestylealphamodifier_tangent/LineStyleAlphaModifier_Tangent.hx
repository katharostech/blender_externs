package bpy.types.linestylealphamodifier_tangent;
...
**/
@:pythonImport("bpy.types.LineStyleAlphaModifier_Tangent") extern class LineStyleAlphaModifier_Tangent {
	/**
		Specify how the modifier value is blended into the base value
		
		Type: enum in [‘MIX’, ‘ADD’, ‘SUBTRACT’, ‘MULTIPLY’, ‘DIVIDE’, ‘DIFFERENCE’, ‘MINIMUM’, ‘MAXIMUM’], default ‘MIX’
	**/
	var blend : bpy.types.linestylealphamodifier_tangent.LineStyleAlphaModifier_Tangent.Enum1;
	/**
	...
	**/
	var mapping : bpy.types.linestylealphamodifier_tangent.LineStyleAlphaModifier_Tangent.Enum2;
	/**
	...
	**/
	var type(default, never) : bpy.types.linestylealphamodifier_tangent.LineStyleAlphaModifier_Tangent.Enum3;
	/**
