package bpy.types.linestylecolormodifier_alongstroke;
...
@:pythonImport("bpy.types.LineStyleColorModifier_AlongStroke") extern class LineStyleColorModifier_AlongStroke {
	...
	**/
	var blend : bpy.types.linestylecolormodifier_alongstroke.LineStyleColorModifier_AlongStroke.Enum1;
	/**
	...
	**/
	var type(default, never) : bpy.types.linestylecolormodifier_alongstroke.LineStyleColorModifier_AlongStroke.Enum2;
	/**
