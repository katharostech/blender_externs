package bpy.types.shadernodeoutputlinestyle;
@:enum abstract Enum1(String) from String to String {
...
}@:pythonImport("bpy.types.ShaderNodeOutputLineStyle") extern class ShaderNodeOutputLineStyle {
	/**
	...
	**/
	var blend_type : bpy.types.shadernodeoutputlinestyle.ShaderNodeOutputLineStyle.Enum1;
	/**
		True if this node is used as the active output
		
		Type: boolean, default False
	**/
	var is_active_output : Bool;
	/**
		Which renderer and viewport shading types to use the shaders for
		
		Type: enum in [‘ALL’, ‘EEVEE’, ‘CYCLES’], default ‘ALL’
	**/
	var target : bpy.types.shadernodeoutputlinestyle.ShaderNodeOutputLineStyle.Enum2;
	/**
