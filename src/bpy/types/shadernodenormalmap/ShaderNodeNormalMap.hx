package bpy.types.shadernodenormalmap;
@:enum abstract Enum1(String) from String to String {
	var TANGENT : String = "TANGENT";
	var OBJECT : String = "OBJECT";
	var WORLD : String = "WORLD";
	var BLENDER_OBJECT : String = "BLENDER_OBJECT";
	var BLENDER_WORLD : String = "BLENDER_WORLD";
}@:pythonImport("bpy.types.ShaderNodeNormalMap") extern class ShaderNodeNormalMap {
	/**
		Space of the input normal
		
		Type: enum in [‘TANGENT’, ‘OBJECT’, ‘WORLD’, ‘BLENDER_OBJECT’, ‘BLENDER_WORLD’], default ‘TANGENT’
	**/
	var space : bpy.types.shadernodenormalmap.ShaderNodeNormalMap.Enum1;
	/**
