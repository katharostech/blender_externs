package bpy.types.distortednoisetexture;
...
@:native("bpy.types.DistortedNoiseTexture") extern class DistortedNoiseTexture {
	...
	**/
	var noise_basis : bpy.types.distortednoisetexture.DistortedNoiseTexture.Enum1;
	/**
		Noise basis for the distortion
		
		Type: enum in [‘BLENDER_ORIGINAL’, ‘ORIGINAL_PERLIN’, ‘IMPROVED_PERLIN’, ‘VORONOI_F1’, ‘VORONOI_F2’, ‘VORONOI_F3’, ‘VORONOI_F4’, ‘VORONOI_F2_F1’, ‘VORONOI_CRACKLE’, ‘CELL_NOISE’], default ‘BLENDER_ORIGINAL’
	**/
	var noise_distortion : bpy.types.distortednoisetexture.DistortedNoiseTexture.Enum2;
	/**
