package bpy.types.compositornodetonemap;
@:enum abstract Enum1(String) from String to String {
	var RD_PHOTORECEPTOR : String = "RD_PHOTORECEPTOR";
	var RH_SIMPLE : String = "RH_SIMPLE";
}@:pythonImport("bpy.types.CompositorNodeTonemap") extern class CompositorNodeTonemap {
	/**
	...
	**/
	var tonemap_type : bpy.types.compositornodetonemap.CompositorNodeTonemap.Enum1;
	/**
