package bpy.types.linestylegeometrymodifier_tipremover;
...
**/
@:pythonImport("bpy.types.LineStyleGeometryModifier_TipRemover") extern class LineStyleGeometryModifier_TipRemover {
	/**
	...
	**/
	var type(default, never) : bpy.types.linestylegeometrymodifier_tipremover.LineStyleGeometryModifier_TipRemover.Enum1;
	/**
