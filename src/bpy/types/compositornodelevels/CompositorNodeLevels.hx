package bpy.types.compositornodelevels;
@:enum abstract Enum1(String) from String to String {
	var COMBINED_RGB : String = "COMBINED_RGB";
	var RED : String = "RED";
	var GREEN : String = "GREEN";
	var BLUE : String = "BLUE";
	var LUMINANCE : String = "LUMINANCE";
}@:pythonImport("bpy.types.CompositorNodeLevels") extern class CompositorNodeLevels {
	/**
		
		
		Type: enum in [‘COMBINED_RGB’, ‘RED’, ‘GREEN’, ‘BLUE’, ‘LUMINANCE’], default ‘COMBINED_RGB’
	**/
	var channel : bpy.types.compositornodelevels.CompositorNodeLevels.Enum1;
	/**
