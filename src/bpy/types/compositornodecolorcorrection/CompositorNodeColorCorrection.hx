package bpy.types.compositornodecolorcorrection;
@:pythonImport("bpy.types.CompositorNodeColorCorrection") extern class CompositorNodeColorCorrection {
	/**
		Blue channel active
	...
	**/
	var highlights_contrast : Float;
	/**
		Highlights gain
		
		Type: float in [0, 4], default 1.0
	**/
	var highlights_gain : Float;
	/**
		Highlights gamma
		
		Type: float in [0, 4], default 1.0
	**/
	var highlights_gamma : Float;
	/**
		Highlights lift
		
		Type: float in [-1, 1], default 0.0
	**/
	var highlights_lift : Float;
	/**
		Highlights saturation
		
		Type: float in [0, 4], default 1.0
	**/
	var highlights_saturation : Float;
	/**
		Master contrast
		
		Type: float in [0, 4], default 1.0
	**/
	var master_contrast : Float;
	/**
		Master gain
		
		Type: float in [0, 4], default 1.0
	**/
	var master_gain : Float;
	/**
		Master gamma
		
		Type: float in [0, 4], default 1.0
	**/
	var master_gamma : Float;
	/**
		Master lift
		
		Type: float in [-1, 1], default 0.0
	**/
	var master_lift : Float;
	/**
		Master saturation
		
		Type: float in [0, 4], default 1.0
	**/
	var master_saturation : Float;
	/**
		Midtones contrast
		
		Type: float in [0, 4], default 1.0
	**/
	var midtones_contrast : Float;
	/**
		End of midtones
		
		Type: float in [0, 1], default 0.7
	**/
	var midtones_end : Float;
	/**
		Midtones gain
		
		Type: float in [0, 4], default 1.0
	**/
	var midtones_gain : Float;
	/**
		Midtones gamma
		
		Type: float in [0, 4], default 1.0
	**/
	var midtones_gamma : Float;
	/**
		Midtones lift
		
		Type: float in [-1, 1], default 0.0
	**/
	var midtones_lift : Float;
	/**
		Midtones saturation
		
		Type: float in [0, 4], default 1.0
	**/
	var midtones_saturation : Float;
	/**
		Start of midtones
		
		Type: float in [0, 1], default 0.2
	**/
	var midtones_start : Float;
	/**
		Red channel active
	...
	**/
	...
	/**
		...
		Type: float in [0, 4], default 1.0
	**/
	var shadows_contrast : Float;
	/**
		Shadows gain
		
		Type: float in [0, 4], default 1.0
	**/
	var shadows_gain : Float;
	/**
		Shadows gamma
		
		Type: float in [0, 4], default 1.0
	**/
	var shadows_gamma : Float;
	/**
		Shadows lift
		
		Type: float in [-1, 1], default 0.0
	**/
	var shadows_lift : Float;
	/**
		Shadows saturation
		
		Type: float in [0, 4], default 1.0
	**/
	var shadows_saturation : Float;
	/**
