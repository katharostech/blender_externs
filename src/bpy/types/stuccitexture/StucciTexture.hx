package bpy.types.stuccitexture;
@:enum abstract Enum1(String) from String to String {
	...
	var PLASTIC : String = "PLASTIC";
	var WALL_IN : String = "WALL_IN";
	var WALL_OUT : String = "WALL_OUT";
}/**
...
@:native("bpy.types.StucciTexture") extern class StucciTexture {
	...
	**/
	var noise_basis : bpy.types.stuccitexture.StucciTexture.Enum1;
	/**
	...
	**/
	var noise_type : bpy.types.stuccitexture.StucciTexture.Enum2;
	/**
		
		
		Type: enum in [‘PLASTIC’, ‘WALL_IN’, ‘WALL_OUT’], default ‘PLASTIC’
	**/
	var stucci_type : bpy.types.stuccitexture.StucciTexture.Enum3;
	/**
