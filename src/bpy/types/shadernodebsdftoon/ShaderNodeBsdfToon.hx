package bpy.types.shadernodebsdftoon;
@:enum abstract Enum1(String) from String to String {
	var DIFFUSE : String = "DIFFUSE";
	var GLOSSY : String = "GLOSSY";
}@:pythonImport("bpy.types.ShaderNodeBsdfToon") extern class ShaderNodeBsdfToon {
	/**
		
		
		Type: enum in [‘DIFFUSE’, ‘GLOSSY’], default ‘DIFFUSE’
	**/
	var component : bpy.types.shadernodebsdftoon.ShaderNodeBsdfToon.Enum1;
	/**
