...
@:pythonImport("bpy.types.IntProperty") extern class IntProperty {
	...
	**/
	var default_array(default, never) : Array<Int>;
	/**
		Maximum value used by buttons
		
		Type: int in [-inf, inf], default 0, (readonly)
	**/
	var hard_max(default, never) : Int;
	/**
		Minimum value used by buttons
		
		Type: int in [-inf, inf], default 0, (readonly)
	**/
	var hard_min(default, never) : Int;
	/**
	...
	**/
	...
	/**
		...
		Type: int in [-inf, inf], default 0, (readonly)
	**/
	var soft_max(default, never) : Int;
	/**
		Minimum value used by buttons
		
		Type: int in [-inf, inf], default 0, (readonly)
	**/
	var soft_min(default, never) : Int;
	/**
		Step size used by number buttons, for floats 1/100th of the step size
		
		Type: int in [0, inf], default 0, (readonly)
	**/
	var step(default, never) : Int;
	/**
