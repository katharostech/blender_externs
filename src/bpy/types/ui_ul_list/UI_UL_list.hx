...
@:native("bpy.types.UI_UL_list") extern class UI_UL_list {
	/**
	...
	**/
	static function filter_items_by_name(pattern:Dynamic, bitflag:Dynamic, items:Dynamic, propname:Dynamic, flags:Dynamic, reverse:Dynamic):Void;
	/**
	...
	**/
	static function sort_items_helper(sort_data:Dynamic, key:Dynamic, reverse:Dynamic):Void;
	/**
