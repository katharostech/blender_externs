package bpy.types.wipesequence;
...
**/
@:pythonImport("bpy.types.WipeSequence") extern class WipeSequence {
	/**
		Edge angle
	...
	**/
	var blur_width : Float;
	/**
		Wipe direction
		
		Type: enum in [‘OUT’, ‘IN’], default ‘OUT’
	**/
	var direction : bpy.types.wipesequence.WipeSequence.Enum1;
	/**
	...
	**/
	var transition_type : bpy.types.wipesequence.WipeSequence.Enum2;
	/**
