package bpy.types.linestylethicknessmodifier_distancefromcamera;
...
@:native("bpy.types.LineStyleThicknessModifier_DistanceFromCamera") extern class LineStyleThicknessModifier_DistanceFromCamera {
	...
	**/
	var blend : bpy.types.linestylethicknessmodifier_distancefromcamera.LineStyleThicknessModifier_DistanceFromCamera.Enum1;
	/**
	...
	**/
	var mapping : bpy.types.linestylethicknessmodifier_distancefromcamera.LineStyleThicknessModifier_DistanceFromCamera.Enum2;
	/**
	...
	**/
	var type(default, never) : bpy.types.linestylethicknessmodifier_distancefromcamera.LineStyleThicknessModifier_DistanceFromCamera.Enum3;
	/**
