package bpy.types.shadernodemath;
@:enum abstract Enum1(String) from String to String {
...
}@:pythonImport("bpy.types.ShaderNodeMath") extern class ShaderNodeMath {
	/**
	...
	**/
	var operation : bpy.types.shadernodemath.ShaderNodeMath.Enum1;
	/**
