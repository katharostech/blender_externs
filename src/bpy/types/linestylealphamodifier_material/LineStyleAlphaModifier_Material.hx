package bpy.types.linestylealphamodifier_material;
...
@:native("bpy.types.LineStyleAlphaModifier_Material") extern class LineStyleAlphaModifier_Material {
	...
	**/
	var blend : bpy.types.linestylealphamodifier_material.LineStyleAlphaModifier_Material.Enum1;
	/**
	...
	**/
	var mapping : bpy.types.linestylealphamodifier_material.LineStyleAlphaModifier_Material.Enum2;
	/**
	...
	**/
	var material_attribute : bpy.types.linestylealphamodifier_material.LineStyleAlphaModifier_Material.Enum3;
	/**
	...
	**/
	var type(default, never) : bpy.types.linestylealphamodifier_material.LineStyleAlphaModifier_Material.Enum4;
	/**
