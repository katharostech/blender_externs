package bpy.types.compositornodemath;
@:enum abstract Enum1(String) from String to String {
	...
	var LOGARITHM : String = "LOGARITHM";
	...
	var ARCSINE : String = "ARCSINE";
	var ARCCOSINE : String = "ARCCOSINE";
	var ARCTANGENT : String = "ARCTANGENT";
	var ARCTAN2 : String = "ARCTAN2";
}@:pythonImport("bpy.types.CompositorNodeMath") extern class CompositorNodeMath {
	/**
	...
	**/
	var operation : bpy.types.compositornodemath.CompositorNodeMath.Enum1;
	/**
