package bpy.types.compositornodechannelmatte;
@:enum abstract Enum1(String) from String to String {
	...
	var G : String = "G";
	var B : String = "B";
}@:pythonImport("bpy.types.CompositorNodeChannelMatte") extern class CompositorNodeChannelMatte {
	/**
		
		
		Type: enum in [‘RGB’, ‘HSV’, ‘YUV’, ‘YCC’], default ‘RGB’
	**/
	var color_space : bpy.types.compositornodechannelmatte.CompositorNodeChannelMatte.Enum1;
	/**
		Limit by this channel’s value
		
		Type: enum in [‘R’, ‘G’, ‘B’], default ‘R’
	**/
	var limit_channel : bpy.types.compositornodechannelmatte.CompositorNodeChannelMatte.Enum2;
	/**
	...
	**/
	var limit_method : bpy.types.compositornodechannelmatte.CompositorNodeChannelMatte.Enum3;
	/**
	...
	**/
	...
	/**
		...
		Type: enum in [‘R’, ‘G’, ‘B’], default ‘R’
	**/
	var matte_channel : bpy.types.compositornodechannelmatte.CompositorNodeChannelMatte.Enum4;
	/**
