package bpy.types.speedcontrolsequence;
/**
	Sequence strip to control the speed of other strips
**/
@:pythonImport("bpy.types.SpeedControlSequence") extern class SpeedControlSequence {
	/**
