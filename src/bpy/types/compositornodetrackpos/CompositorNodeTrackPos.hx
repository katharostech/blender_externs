package bpy.types.compositornodetrackpos;
@:enum abstract Enum1(String) from String to String {
	var ABSOLUTE : String = "ABSOLUTE";
	var RELATIVE_START : String = "RELATIVE_START";
	var RELATIVE_FRAME : String = "RELATIVE_FRAME";
	var ABSOLUTE_FRAME : String = "ABSOLUTE_FRAME";
}@:pythonImport("bpy.types.CompositorNodeTrackPos") extern class CompositorNodeTrackPos {
	/**
	...
	**/
	var position : bpy.types.compositornodetrackpos.CompositorNodeTrackPos.Enum1;
	/**
