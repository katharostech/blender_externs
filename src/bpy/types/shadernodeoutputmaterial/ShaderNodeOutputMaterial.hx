package bpy.types.shadernodeoutputmaterial;
@:enum abstract Enum1(String) from String to String {
	var ALL : String = "ALL";
	var EEVEE : String = "EEVEE";
	var CYCLES : String = "CYCLES";
}@:pythonImport("bpy.types.ShaderNodeOutputMaterial") extern class ShaderNodeOutputMaterial {
	/**
	...
	**/
	var target : bpy.types.shadernodeoutputmaterial.ShaderNodeOutputMaterial.Enum1;
	/**
