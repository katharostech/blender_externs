package bpy.types.shadernodeoutputlight;
@:enum abstract Enum1(String) from String to String {
	var ALL : String = "ALL";
	var EEVEE : String = "EEVEE";
	var CYCLES : String = "CYCLES";
}@:pythonImport("bpy.types.ShaderNodeOutputLight") extern class ShaderNodeOutputLight {
	/**
	...
	**/
	var target : bpy.types.shadernodeoutputlight.ShaderNodeOutputLight.Enum1;
	/**
