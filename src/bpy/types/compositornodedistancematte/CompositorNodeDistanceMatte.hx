package bpy.types.compositornodedistancematte;
@:enum abstract Enum1(String) from String to String {
	var RGB : String = "RGB";
	var YCC : String = "YCC";
}@:pythonImport("bpy.types.CompositorNodeDistanceMatte") extern class CompositorNodeDistanceMatte {
	/**
		
		
		Type: enum in [‘RGB’, ‘YCC’], default ‘RGB’
	**/
	var channel : bpy.types.compositornodedistancematte.CompositorNodeDistanceMatte.Enum1;
	/**
