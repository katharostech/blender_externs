package bpy.types.tracktoconstraint;
...
**/
@:pythonImport("bpy.types.TrackToConstraint") extern class TrackToConstraint {
	/**
	...
	**/
	var track_axis : bpy.types.tracktoconstraint.TrackToConstraint.Enum1;
	/**
		Axis that points upward
		
		Type: enum in [‘UP_X’, ‘UP_Y’, ‘UP_Z’], default ‘UP_X’
	**/
	var up_axis : bpy.types.tracktoconstraint.TrackToConstraint.Enum2;
	/**
