...
@:pythonImport("bpy.types.World") extern class World {
	...
	**/
	var cycles(default, never) : bpy.types.cyclesworldsettings.CyclesWorldSettings;
	/**
	...
	**/
	var light_settings(default, never) : bpy.types.worldlighting.WorldLighting;
	/**
		World mist settings
		
		Type: WorldMistSettings, (readonly, never None)
	**/
	var mist_settings(default, never) : bpy.types.worldmistsettings.WorldMistSettings;
	/**
