package bpy.types.linestylecolormodifier_curvature_3d;
...
**/
@:pythonImport("bpy.types.LineStyleColorModifier_Curvature_3D") extern class LineStyleColorModifier_Curvature_3D {
	/**
	...
	**/
	var blend : bpy.types.linestylecolormodifier_curvature_3d.LineStyleColorModifier_Curvature_3D.Enum1;
	/**
	...
	**/
	var type(default, never) : bpy.types.linestylecolormodifier_curvature_3d.LineStyleColorModifier_Curvature_3D.Enum2;
	/**
