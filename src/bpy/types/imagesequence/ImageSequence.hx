package bpy.types.imagesequence;
...
**/
@:pythonImport("bpy.types.ImageSequence") extern class ImageSequence {
	/**
		Representation of alpha information in the RGBA pixels
		
		Type: enum in [‘STRAIGHT’, ‘PREMUL’], default ‘STRAIGHT’
	**/
	var alpha_mode : bpy.types.imagesequence.ImageSequence.Enum1;
	/**
	...
	**/
	var elements(default, never) : bpy.types.sequenceelements.SequenceElements;
	/**
	...
	**/
	var views_format : bpy.types.imagesequence.ImageSequence.Enum2;
	/**
