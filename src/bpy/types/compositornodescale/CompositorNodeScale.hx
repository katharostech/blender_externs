package bpy.types.compositornodescale;
@:enum abstract Enum1(String) from String to String {
	...
	var SCENE_SIZE : String = "SCENE_SIZE";
	var RENDER_SIZE : String = "RENDER_SIZE";
}@:pythonImport("bpy.types.CompositorNodeScale") extern class CompositorNodeScale {
	/**
		How the image fits in the camera frame
		
		Type: enum in [‘STRETCH’, ‘FIT’, ‘CROP’], default ‘STRETCH’
	**/
	var frame_method : bpy.types.compositornodescale.CompositorNodeScale.Enum1;
	/**
	...
	**/
	var space : bpy.types.compositornodescale.CompositorNodeScale.Enum2;
	/**
