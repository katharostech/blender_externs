package bpy.types.shadernodebsdfrefraction;
@:enum abstract Enum1(String) from String to String {
	var SHARP : String = "SHARP";
	var BECKMANN : String = "BECKMANN";
	var GGX : String = "GGX";
}@:pythonImport("bpy.types.ShaderNodeBsdfRefraction") extern class ShaderNodeBsdfRefraction {
	/**
		
		
		Type: enum in [‘SHARP’, ‘BECKMANN’, ‘GGX’], default ‘BECKMANN’
	**/
	var distribution : bpy.types.shadernodebsdfrefraction.ShaderNodeBsdfRefraction.Enum1;
	/**
