package bpy.types.shadernodevectordisplacement;
@:enum abstract Enum1(String) from String to String {
	var TANGENT : String = "TANGENT";
	var OBJECT : String = "OBJECT";
	var WORLD : String = "WORLD";
}@:pythonImport("bpy.types.ShaderNodeVectorDisplacement") extern class ShaderNodeVectorDisplacement {
	/**
		Space of the input height
		
		Type: enum in [‘TANGENT’, ‘OBJECT’, ‘WORLD’], default ‘TANGENT’
	**/
	var space : bpy.types.shadernodevectordisplacement.ShaderNodeVectorDisplacement.Enum1;
	/**
