...
**/
@:native("freestyle.chainingiterators.ChainPredicateIterator") extern class ChainPredicateIterator {
	/**
...
**/
@:native("freestyle.chainingiterators.ChainSilhouetteIterator") extern class ChainSilhouetteIterator {
	/**
...
**/
@:native("freestyle.chainingiterators.pyChainSilhouetteIterator") extern class PyChainSilhouetteIterator {
	function init():Void;
	function traverse(iter:Dynamic):Void;
}/**
	Natural chaining iterator that follows the edges of the same nature
	following the topology of objects, with decreasing priority for
	...
	edge types.
**/
@:native("freestyle.chainingiterators.pyChainSilhouetteGenericIterator") extern class PyChainSilhouetteGenericIterator {
	/**
...
**/
@:native("freestyle.chainingiterators.pyExternalContourChainingIterator") extern class PyExternalContourChainingIterator {
	function checkViewEdge(ve:Dynamic, orientation:Dynamic):Void;
	function init():Void;
	function traverse(iter:Dynamic):Void;
}/**
...
**/
@:native("freestyle.chainingiterators.pySketchyChainSilhouetteIterator") extern class PySketchyChainSilhouetteIterator {
	/**
	...
	**/
	...
	ViewEdge.
**/
@:native("freestyle.chainingiterators.pySketchyChainingIterator") extern class PySketchyChainingIterator {
	function init():Void;
	function traverse(iter:Dynamic):Void;
}/**
	Chaining iterator that fills small occlusions
**/
@:native("freestyle.chainingiterators.pyFillOcclusionsRelativeChainingIterator") extern class PyFillOcclusionsRelativeChainingIterator {
	/**
	...
	**/
	function __init__(percent:Float):Void;
	function init():Void;
	function traverse(iter:Dynamic):Void;
}/**
	Chaining iterator that fills small occlusions
**/
@:native("freestyle.chainingiterators.pyFillOcclusionsAbsoluteChainingIterator") extern class PyFillOcclusionsAbsoluteChainingIterator {
	/**
	...
	**/
	function __init__(length:Int):Void;
	function init():Void;
	function traverse(iter:Dynamic):Void;
}/**
	...
	selection.
**/
@:native("freestyle.chainingiterators.pyFillOcclusionsAbsoluteAndRelativeChainingIterator") extern class PyFillOcclusionsAbsoluteAndRelativeChainingIterator {
	/**
	...
	**/
	function __init__(percent:Float, l:Float):Void;
	function init():Void;
	function traverse(iter:Dynamic):Void;
}/**
	Chaining iterator that fills small occlusions regardless of the
	selection.
**/
@:native("freestyle.chainingiterators.pyFillQi0AbsoluteAndRelativeChainingIterator") extern class PyFillQi0AbsoluteAndRelativeChainingIterator {
	/**
...
**/
@:native("freestyle.chainingiterators.pyNoIdChainSilhouetteIterator") extern class PyNoIdChainSilhouetteIterator {
	/**
